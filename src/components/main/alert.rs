...
#[component]
pub fn Alerts(alert: RwSignal<Alert>) -> impl IntoView {
    ...
    view! {
        ...
        >
            <div class="flex">
                ...
                <div class="ms-4">
                    <h3 class="text-sm font-semibold">{move || { alert.get().message.clone() }}</h3>
                    <div class="mt-1 text-sm">
                        {move || { alert.get().details.as_deref().unwrap_or_default().to_string() }}
                    </div>
                </div>
